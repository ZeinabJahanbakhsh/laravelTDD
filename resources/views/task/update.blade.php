    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                ...
                <!-- component -->
                <div class="heading text-center font-bold text-2xl m-5 text-gray-800">Update task</div>

                @if(count($errors))
                    <div class="text-red-500 text-xs italic text-center">
